...
import warnings
warnings.warn("ibpykernel.datapub is deprecated. It has moved to ipyparallel.datapub", DeprecationWarning)
...
from ibpykernel.serialize import serialize_object
