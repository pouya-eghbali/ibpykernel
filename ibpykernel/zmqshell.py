...
from ibpykernel import (
    get_connection_file, get_connection_info, connect_qtconsole
)
from IPython.utils import openpy
from ibpykernel.jsonutil import json_clean, encode_images
...
from ibpykernel.displayhook import ZMQShellDisplayHook

from jupyter_core.paths import jupyter_runtime_dir
from jupyter_client.session import extract_header, Session

import brackets.shell
...
class ZMQDisplayPublisher(DisplayPublisher):
    ...
    # is processed. See ibpykernel Issue 113 for a discussion.
    _thread_local = Any()
...
class ZMQInteractiveShell(InteractiveShell):
    ...
    data_pub_class = Type('ibpykernel.datapub.ZMQDataPublisher')
    kernel = Any()
    parent_header = Any()
