...
class IPKernelApp(BaseIPythonApplication, InteractiveShellApp,
    ...
    kernel_class = Type('ibpykernel.ipkernel.IPythonKernel',
                        klass='ibpykernel.kernelbase.Kernel',
    ...
    subcommands = {
        'install': (
            'ibpykernel.kernelspec.InstallIPythonKernelSpecApp',
    ...
    outstream_class = DottedObjectName('ibpykernel.iostream.OutStream',
        help="The importstring for the OutStream factory").tag(config=True)
    displayhook_class = DottedObjectName('ibpykernel.displayhook.ZMQDisplayHook',
    ...
    def init_gui_pylab(self):
        ...
        if not os.environ.get('MPLBACKEND'):
            os.environ['MPLBACKEND'] = 'module://ibpykernel.pylab.backend_inline'
