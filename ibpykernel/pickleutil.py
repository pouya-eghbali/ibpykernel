...
import warnings
warnings.warn("ibpykernel.pickleutil is deprecated. It has moved to ipyparallel.", DeprecationWarning)
...
try:
    ...
    # Deprecated since ibpykernel 4.3.1
    from ibpykernel import codeutil
...
def use_dill():
    ...
    try:
        from ibpykernel import serialize
    except ImportError:
        pass
    else:
